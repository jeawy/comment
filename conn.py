...
class ConnectDBA(object):
    ...
    """
    pro = ['221.214.214.144:53281', '113.77.240.236:9797', '221.7.49.209:53281', '61.135.217.7','116.6.228.51:808'
    ...
    def __init__(self ):
        db = MySQLdb.connect(host="192.168.1.104",user="root",passwd="sqlroot",db="comment_zh",charset="utf8mb4") 
